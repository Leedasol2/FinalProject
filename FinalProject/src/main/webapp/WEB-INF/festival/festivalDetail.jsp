...
<body>
<!-- 날짜 차이 구하기 -->
<fmt:parseDate value="${tdto.beginday }" var="startDate" pattern="yyyy-MM-dd"/>
<fmt:parseNumber value="${startDate.time / (1000*60*60*24) }" integerOnly="true" var="start"></fmt:parseNumber>
<fmt:parseDate value="${tdto.endday }" var="endDate" pattern="yyyy-MM-dd"/>
<fmt:parseNumber value="${endDate.time / (1000*60*60*24) }" integerOnly="true" var="end"></fmt:parseNumber>
...
$(function(){
	...
	<img alt="" src="${root }/image/festival/${fn:split(tdto.image,',')[0]}" class="tripimage">
	<div class="smimage2">
	<img alt="" src="${root }/image/festival/${fn:split(tdto.image,',')[0]}" class="small2">
	<img alt="" src="${root }/image/festival/${fn:split(tdto.image,',')[1]}" class="small2">
	<img alt="" src="${root }/image/festival/${fn:split(tdto.image,',')[2]}" class="small2">
	<img alt="" src="${root }/image/festival/${fn:split(tdto.image,',')[3]}" class="small2">
	<img alt="" src="${root }/image/festival/${fn:split(tdto.image,',')[4]}" class="small2">
	</div>
	<hr>
